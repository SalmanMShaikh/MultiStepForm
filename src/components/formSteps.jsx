  ...
  return (
    ...
    <div className="imageOne">
        <div className="steps-container">
            ...
            <div className='step-description' >step 1<br /> <span className='bold-font'>YOUR INFO</span></div>
        </div>
        ...
        <div className="steps-container">
            ...
            <div className='step-description' >step 2<br /> <span className='bold-font'>SELECT PLANS</span></div>
        </div>
        ...
        <div className="steps-container">
            ...
            <div className='step-description' >step 3<br /> <span className='bold-font'>ADD-ONS</span></div>
        </div>
        ...
        <div className="steps-container">
            ...
            <div className='step-description' >step 4<br /> <span className='bold-font'>SUMMARY</span></div>
        </div>
