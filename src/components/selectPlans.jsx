                ...
                <div className="personalInfoRightSide">
                    ...
                    <div className="personalInfoForm">
                        <div className="firstRowForm">
                            ...
                            <p style={{color: 'grey', fontSize: '15px'}}>$90/yr</p>
                            <p style={{color: 'black', fontSize:'12px'}}>2 months free</p>
                            </div>
                            </div>
                            ...
                            <p style={{color: 'grey', fontSize: '15px'}}>$120/yr</p>
                            <p style={{color: 'black', fontSize:'12px'}}>2 months free</p>
                            </div>
                            </div>
                        ...
                        <div className="secondRowForm">
                            <div className="buttonbox"> <span id="span">Annually</span>
                                <button className={`pricing-button ${isActive ? 'active' : ''}`} onClick={()=>{togglePricing()}}>
